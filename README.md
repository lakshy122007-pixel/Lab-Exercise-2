...
2 .Select suitable Gestalt Principles such as:
   ...
   Figure-Ground
   Common Region
3. Create a basic wireframe for the mobile and web interfaces.
4. Group related elements using the Principle of Proximity.
5. Use consistent colors, shapes, fonts, and icons according to the Principle of Similarity.
6. Arrange elements in a natural visual flow using Continuity.
7. Use incomplete shapes or familiar patterns where appropriate using Closure.
8. Clearly separate foreground elements from the background using Figure-Ground.
9. Place related elements inside cards, sections, or containers using Common Region.
10. Apply UI elements and design patterns such as buttons, navigation bars, cards, forms, and menus.
11. Create the final mobile and web layouts using a design tool such as Figma or Canva.
